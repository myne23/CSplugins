        ...
        return try {
            ...
            val hlsUrl = when {
                ...
                !hls2.isNullOrBlank() -> {
                    Log.d(
                        "MegadedeProvider",
                        "Vidhide directo: hls4 no disponible, usando hls2"
                    )
                    hls2
                }
                ...
                !hls3.isNullOrBlank() -> {
                    Log.d(
                        "MegadedeProvider",
                        "Vidhide directo: hls4/hls2 no disponibles, usando hls3"
                    )
                    hls3
                }
            ...
            if (hlsUrl.isNullOrBlank()) {
                Log.d(
                    "MegadedeProvider",
                    "Vidhide directo: no se encontró hls4/hls2/hls3"
                )
                return null
            }

            val result = if (hlsUrl.startsWith("http")) {
                hlsUrl
            } else {
                "https://morencius.com$hlsUrl"
            }
